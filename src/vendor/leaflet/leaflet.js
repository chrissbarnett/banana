...
!function (t, e, i) {
    ...
    s.addEventListener = s.on, s.removeEventListener = s.clearAllEventListeners = s.off, s.addOneTimeEventListener = s.once, s.fireEvent = s.fire, s.hasEventListeners = s.listens, o.Mixin = {Events: s}, function () {
        ...
        options: {
            ...
            if (n) {
                ...
                if (t === i && (t = n.getCenter()), this._tileZoom !== i) {
                    var r = this._getTiledPixelBounds(t, s, this._tileZoom), a = this._pxBoundsToTileRange(r), h = a.getCenter(), l = [];
        ...
        options: {padding: .1}, initialize: function (t) {
            ...
            var t = {viewreset: this._reset, zoomstart: this._onZoomStart, zoom: this._onZoom, moveend: this._update};
        ...
        onAdd: function () {
            ...
            var e = this._map.mouseEventToLayerPoint(t), i = [];
