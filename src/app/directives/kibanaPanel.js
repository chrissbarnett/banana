...
function (angular) {
  'use strict';
    //use with newer angular strap version
  angular
    .module('kibana.directives')
      .directive('kibanaPanel', function ($compile, $timeout) {
      var container = '<div class="panelCont"></div>';
          ...
          '<span class="row-button extra" ng-show="panel.editable != false">' +
              '<span bs-modal data-template-url="app/partials/paneleditor.html" class="pointer">' +
              '<i class="icon-cog pointer" bs-tooltip data-title="Configure"></i></span>' +
          '</span>' +
          ...
          '<span ng-repeat="task in panelMeta.modals" class="row-button extra" ng-show="panel.spyable">' +
              ...
              'bs-tooltip data-title="{{panel.helptext}}" ng-class="task.icon" class="pointer"></i></span>' +
          '</span>' +
            ...
            '<ul class="dropdown-menu" style="padding:10px; left:-150px;">' +
              '<h5>Number of Rows</h5><form><input type="number" ng-model="panel.exportSize" placeholder="{{panel.size * panel.pages}}"/>' +
