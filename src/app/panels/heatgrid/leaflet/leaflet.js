...
!function (t, e, i) {
    ...
    o.Mixin = {}, o.Mixin.Events = {
        addEventListener: function (t, e, i) {
            ...
            for (t = o.Util.splitWords(t), n = 0, a = t.length; a > n; n++)r = {
                action: e,
                context: i || this
            }, h = t[n], i ? (l = h + "_idx", u = l + "_len", c = d[l] = d[l] || {}, c[_] || (c[_] = [], d[u] = (d[u] || 0) + 1), c[_].push(r)) : (d[h] = d[h] || [], d[h].push(r));
            return this
            ...
            var n, a, r, h, l, u, c, d, _, p = this[s], m = i && o.stamp(i);
            for (t = o.Util.splitWords(t), n = 0, a = t.length; a > n; n++)if (r = t[n], u = r + "_idx", c = u + "_len", d = p[u], e) {
                if (h = i && d ? d[m] : p[r]) {
                    for (l = h.length - 1; l >= 0; l--)h[l].action !== e || i && h[l].context !== i || (_ = h.splice(l, 1), _[0].action = o.Util.falseFn);
                    i && d && 0 === h.length && (delete d[m], p[c]--)
                }
        ...
        initialize: function (t, e) {
            e = o.setOptions(this, e), this._initContainer(t), this._initLayout(), this._initEvents(), e.maxBounds && this.setMaxBounds(e.maxBounds), e.center && e.zoom !== i && this.setView(o.latLng(e.center), e.zoom, {reset: !0}), this._initLayers(e.layers), this._handlers = [], this.callInitHooks()
        },
        ...
        removeLayer: function (t) {
            var e = o.stamp(t);
            if (this._layers[e])return this._loaded && (t.onRemove(this), this.fire("layerremove", {layer: t})), delete this._layers[e], this._zoomBoundLayers[e] && (delete this._zoomBoundLayers[e], this._updateZoomLevels()), this.options.zoomAnimation && o.TileLayer && t instanceof o.TileLayer && (this._tileLayersNum--, this._tileLayersToLoad--, t.off("load", this._onTileLayerLoad, this)), this
        },
        hasLayer: function (t) {
        ...
        invalidateSize: function (t) {
            ...
            return (0 !== n.x || 0 !== n.y) && (t === !0 ? this.panBy(n) : (this._rawPanBy(n), this.fire("move"), clearTimeout(this._sizeTimer), this._sizeTimer = setTimeout(o.bind(this.fire, this, "moveend"), 200)), this.fire("resize", {
                oldSize: e,
                newSize: i
            })), this
        },
        ...
        project: function (t) {
            ...
            return h = -a * Math.log(d), new o.Point(r, h)
        },
        unproject: function (t) {
            for (var e, i = o.LatLng.RAD_TO_DEG, n = this.R_MAJOR, s = this.R_MINOR, a = t.x * i / n, r = s / n, h = Math.sqrt(1 - r * r), l = Math.exp(-t.y / s), u = Math.PI / 2 - 2 * Math.atan(l), c = 15, d = 1e-7, _ = c, p = .1; Math.abs(p) > d && --_ > 0;)e = h * Math.sin(u), p = Math.PI / 2 - 2 * Math.atan(l * Math.pow((1 - e) / (1 + e), .5 * h)) - u, u += p;
        ...
        _updateOpacity: function () {
            ...
            if (o.Browser.webkit)for (t in e)e[t].style.webkitTransform += " translate(0,0)"
        },
        ...
        defaultWmsParams: {
            ...
            var i = this._map, n = i.options.crs, s = this.options.tileSize, a = t.multiplyBy(s), r = a.add([s, s]), h = n.project(i.unproject(a, e)), l = n.project(i.unproject(r, e)), u = [h.x, l.y, l.x, h.y].join(","), c = o.Util.template(this._url, {s: this._getSubdomain(t)});
            return c + o.Util.getParamString(this.wmsParams, c, !0) + "&BBOX=" + u
        ...
        _initIcon: function () {
            var t = this.options, e = this._map, i = e.options.zoomAnimation && e.options.markerZoomAnimation, n = i ? "leaflet-zoom-animated" : "leaflet-zoom-hide", s = !1, a = this._icon;
            if (a) {
                var r = t.icon.createIcon(this._icon);
                r !== this._icon && (this._removeIcon(), this._icon = r, a = !1)
            } else this._icon = t.icon.createIcon();
            t.title && (this._icon.title = t.title), this._initInteraction(), s = t.opacity < 1, o.DomUtil.addClass(this._icon, n), t.riseOnHover && o.DomEvent.on(this._icon, "mouseover", this._bringToFront, this).on(this._icon, "mouseout", this._resetZIndex, this);
            var h = this._shadow;
            h ? this._shadow = t.icon.createShadow(this._shadow) : (this._shadow = t.icon.createShadow(), this._shadow && (o.DomUtil.addClass(this._shadow, n), s = t.opacity < 1)), s && this._updateOpacity();
            var l = this._map._panes;
            a || l.markerPane.appendChild(this._icon), this._shadow && !h && l.shadowPane.appendChild(this._shadow)
        },
        ...
        openPopup: function () {
            ...
            return i = i.add(o.Popup.prototype.options.offset), e && e.offset && (i = i.add(e.offset)), e = o.extend({offset: i}, e), this._popup || this.on("click", this.openPopup, this).on("remove", this.closePopup, this).on("move", this._movePopup, this), t instanceof o.Popup ? (o.setOptions(t, e), this._popup = t) : this._popup = new o.Popup(e, this).setContent(t), this
        ...
        removeLayer: function (t) {
            return t in this._layers && (t = this._layers[t]), t.off(o.FeatureGroup.EVENTS, this._propagateEvent, this), o.LayerGroup.prototype.removeLayer.call(this, t), this._popupContent && this.invoke("unbindPopup"), this.fire("layerremove", {layer: t})
        },
        bindPopup: function (t, e) {
        ...
        includes: [o.Mixin.Events],
        statics: {CLIP_PADDING: o.Browser.mobile ? Math.max(0, Math.min(.5, (1280 / Math.max(t.innerWidth, t.innerHeight) - 1) / 2)) : .5},
        options: {
            stroke: !0,
            color: "#0033ff",
            dashArray: null,
        ...
        for (a = 0; 4 > a; a++) {
            for (u = d[a], i = [], n = 0, l = t.length, s = l - 1; l > n; s = n++)r = t[n], h = t[s], r._code & u ? h._code & u || (c = _._getEdgeIntersection(h, r, u, e), c._code = _._getBitCode(c, e), i.push(c)) : (h._code & u && (c = _._getEdgeIntersection(h, r, u, e), c._code = _._getBitCode(c, e), i.push(c)), i.push(r));
            t = i
        }
        return t
        ...
        toGeoJSON: function () {
            return {type: "Point", coordinates: o.GeoJSON.latLngToCoords(this.getLatLng())}
        }
    }), o.Polyline.include({
        toGeoJSON: function () {
            return {type: "LineString", coordinates: o.GeoJSON.latLngsToCoords(this.getLatLngs())}
        }
    }), o.Polygon.include({
        toGeoJSON: function () {
        ...
        addListener: function (t, e, i, n) {
            ...
            var n = e.body, s = e.documentElement, a = t.pageX ? t.pageX : t.clientX + n.scrollLeft + s.scrollLeft, r = t.pageY ? t.pageY : t.clientY + n.scrollTop + s.scrollTop, h = new o.Point(a, r);
            ...
            return n && n > 100 && 400 > n ? (o.DomEvent.stop(t), void 0) : (o.DomEvent._lastClick = i, e(t))
        }
        ...
        _onDown: function (t) {
            if (!t.shiftKey && (1 === t.which || 1 === t.button || t.touches) && (o.DomEvent.preventDefault(t).stopPropagation(t), !o.Draggable._disabled)) {
                ...
                if (i > 1)return this._simulateClick = !1, clearTimeout(this._longPressTimeout), void 0;
                var n = 1 === i ? t.touches[0] : t, s = n.target;
                o.Browser.touch && "a" === s.tagName.toLowerCase() && o.DomUtil.addClass(s, "leaflet-active"), this._moved = !1, this._moving || (this._startPoint = new o.Point(n.clientX, n.clientY), this._startPos = this._newPos = o.DomUtil.getPosition(this._element), 1 === i && o.Browser.touch && this._longPress && (this._longPressTimeout = setTimeout(o.bind(function () {
                    ...
                    t < o.Draggable.TAP_TOLERANCE && (this._simulateClick = !1, this._onUp(), this._simulateEvent("contextmenu", n))
        ...
        _onUp: function (t) {
            var i, n, s, a, r;
            clearTimeout(this._longPressTimeout), this._simulateClick && t.changedTouches && (s = this._newPos && this._newPos.distanceTo(this._startPos) || 0, i = t.changedTouches[0], n = i.target, "a" === n.tagName.toLowerCase() && o.DomUtil.removeClass(n, "leaflet-active"), s < o.Draggable.TAP_TOLERANCE && (a = !0)), o.Browser.touch || (o.DomUtil.enableTextSelection(), o.DomUtil.removeClass(e.body, "leaflet-dragging"));
            for (r in o.Draggable.MOVE)o.DomEvent.off(e, o.Draggable.MOVE[r], this._onMove).off(e, o.Draggable.END[r], this._onUp);
            this._moved && (o.Util.cancelAnimFrame(this._animRequest), this.fire("dragend")), this._moving = !1, a && (this._moved = !1, this._simulateEvent("click", i))
        },
        ...
        addHooks: function () {
            ...
            if (t.fire("dragend"), n)t.fire("moveend"); else {
                var s = this._lastPos.subtract(this._positions[0]), a = (this._lastTime + i - this._times[0]) / 1e3, r = e.easeLinearity, h = s.multiplyBy(r / a), l = h.distanceTo([0, 0]), u = Math.min(e.inertiaMaxSpeed, l), c = h.multiplyBy(u / l), d = u / (e.inertiaDeceleration * r), _ = c.multiplyBy(-d / 2).round();
                _.x && _.y ? o.Util.requestAnimFrame(function () {
                    t.panBy(_, {duration: d, easeLinearity: r, noMoveStart: !0})
                }) : t.fire("moveend")
            }
        }
        ...
        addDoubleTapListener: function (t, i, n) {
            function s(t) {
                var e;
                if (o.Browser.msTouch ? (p.push(t.pointerId), e = p.length) : e = t.touches.length, !(e > 1)) {
            ...
            return t.addEventListener(d, s, !1), m.addEventListener(_, a, !1), o.Browser.msTouch && m.addEventListener("MSPointerCancel", a, !1), this
        },
    ...
    }),o.Map.addInitHook("addHandler", "touchZoom", o.Map.TouchZoom),o.Map.mergeOptions({boxZoom: !0}),o.Map.BoxZoom = o.Handler.extend({
        initialize: function (t) {
        ...
        keyCodes: {
            ...
            if (e in this._panKeys)i.panBy(this._panKeys[e]), i.options.maxBounds && i.panInsideBounds(i.options.maxBounds); else {
        ...
        includes: o.Mixin.Events, run: function (t, e, i, n) {
            ...
            return o.Browser.any3d ? (n = a[o.DomUtil.TRANSFORM].match(this._transformRe), e = parseFloat(n[1]), i = parseFloat(n[2])) : (e = parseFloat(a.left), i = parseFloat(a.top)), new o.Point(e, i, !0)
        ...
        _catchTransitionEnd: function () {
            ...
            if (i = i || {}, !this.options.zoomAnimation || i.animate === !1 || !o.DomUtil.TRANSITION || o.Browser.android23 || o.Browser.mobileOpera || Math.abs(e - this._zoom) > this.options.zoomAnimationThreshold)return !1;
            var n = this.getZoomScale(e), s = this._getCenterOffset(t)._divideBy(1 - 1 / n), a = this._getCenterLayerPoint()._add(s);
            return i.animate === !0 || this.getSize().contains(s) ? (this.fire("movestart").fire("zoomstart"), this._animateZoom(t, e, a, n), !0) : !1
        }, _animateZoom: function (t, e, i, n, s) {
        ...
        _animateZoom: function (t) {
            ...
            var n = o.DomUtil.TRANSFORM, s = t.delta ? o.DomUtil.getTranslateString(t.delta) : i.style[n];
            i.style[n] = s + " " + o.DomUtil.getScaleString(t.scale, t.origin)
        ...
        _defaultLocateOptions: {
            ...
            var u = o.extend({latlng: n, bounds: r}, t.coords);
